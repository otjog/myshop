                ...
                <div class="banner_content">
                    ...
                    <div class="banner_price">
                        ...
                        @if( isset($banner->data->price['sale']) && $banner->data->price['sale'] > 0)
                            <span>
                            {{$banner->data->price['value'] + $banner->data->price['sale']}}<small>{{$global_data['components']['shop']['currency']['symbol']}}</small>
                        </span>
                        @endif
                        {{$banner->data->price['value']}}<small>{{$global_data['components']['shop']['currency']['symbol']}}</small>
                    </div>
