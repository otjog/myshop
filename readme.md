...
<ol>
    <li>
        Элемента формы добавлены универсальные data атрибуты, для работы ajax 
    </li>
</ol> 
<strong>
    НЕ СДЕЛАНО:
    После AJAX запрооса фильтра, слетают слушатели с кнопок В Корзину у товаров в категории
</strong>
<hr>
